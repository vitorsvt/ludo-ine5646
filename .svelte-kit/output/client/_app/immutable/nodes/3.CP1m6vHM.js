...
`)+`
`+h);const b=y+m+a,T=y+h+o,R=ll(r,r.VERTEX_SHADER,b),E=ll(r,r.FRAGMENT_SHADER,T);r.attachShader(M,R),r.attachShader(M,E),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function D(w){if(i.debug.checkShaderErrors){const L=r.getProgramInfoLog(M)||"",O=r.getShaderInfoLog(R)||"",k=r.getShaderInfoLog(E)||"",W=L.trim(),G=O.trim(),ee=k.trim();let H=!0,Q=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,R,E);else{const te=hl(r,R,"vertex"),Me=hl(r,E,"fragment");mt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
